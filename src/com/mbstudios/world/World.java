...
import com.mbstudios.entities.Fruta;
...
//						Maçã
						...
						Enemy enemy  = new Enemy(xx*16, yy*16, 16, 16, 1, Entity.ENEMY_SPRITE1);
						Game.entities.add(enemy);
					}else if(pixelAtual == 0xFFFFB27F) {
						Enemy enemy = new Enemy(xx*16, yy*16, 16, 16, 1, Entity.ENEMY_SPRITE2);
						Game.entities.add(enemy);
					}
				}
			}
